<div class="p-6 lg:p-8"
     x-data="{ saved: false }"
     @question-saved.window="saved = true; setTimeout(() => saved = false, 3000)">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
            <nav class="flex items-center gap-1.5 text-sm text-on-surface-variant mb-2 font-cairo">
                ...
                <span class="material-symbols-outlined text-[14px]">chevron_left</span>
                <span class="text-on-surface font-semibold">إنشاء سؤال</span>
            </nav>
            <h1 class="text-3xl font-extrabold text-primary font-headline tracking-tight">إنشاء سؤال جديد</h1>
            <p class="text-on-surface-variant mt-1 text-sm font-cairo">صمّم سؤالاً دقيقاً ليكون أداةً تقييمية عادلة</p>
        </div>
        <div class="flex flex-wrap gap-3 shrink-0">
            ...
            <button wire:click="saveAndAnother"
                    class="px-5 py-2.5 rounded-xl border-2 border-primary/30 text-primary font-semibold hover:bg-primary-fixed/30 transition-colors flex items-center gap-2 font-cairo text-sm">
    ...
    <div x-show="saved"
         ...
         class="mb-6 flex items-center gap-3 bg-emerald-50 border border-emerald-200 text-emerald-800 px-5 py-3.5 rounded-xl shadow-sm font-cairo text-sm font-semibold">
        <span class="material-symbols-outlined text-emerald-600 icon-filled">check_circle</span>
        تم حفظ السؤال بنجاح! يمكنك إضافة سؤال جديد.
    </div>
            ...
            <div class="bg-surface-container-low rounded-2xl border border-outline-variant/20 p-6 space-y-5 lg:sticky lg:top-20">
                ...
                <div class="pt-2 border-t border-outline-variant/20">
                    <div class="flex items-start gap-2 bg-primary-fixed/40 text-on-primary-fixed-variant px-3.5 py-3 rounded-xl text-xs font-cairo leading-relaxed">
                        ...
                        <span>يُحفظ السؤال في بنك أسئلتك الخاص ويمكن استخدامه في أي امتحان لاحق.</span>
                    </div>
                </div>
